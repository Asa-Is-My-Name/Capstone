...
questions = [
    ...
    {
        "question": "Plants use CO2 and H2O to produce glucose (sugar) necessary to survive in which process?",
        "choices": ["A. Electrophoresis", "B. Photosynthesis", "C. Carbon fusion", "D. Bioengineering", "E. Respiration"],
        "answer": "B",
        "hints": ["plants.jpg"]
    },
    {
        "question": "Which process led to the removal of CO2 from the atmosphere in the Carboniferous period?",
        "choices": ["A. Chemosynthesis", "B. Respiration", "C. Carbon fusion", "D. Photosynthesis", "E. Respiration"],
        "answer": "D",
        "hints": ["carboniferous.jpg"]
    },
    {
        ...
        "answer": "A",
        "hints": ["latent_heat.jpg", "radiation.png"]
    },
    {
    ...
    },
    {
        ...
        "choices": ["A. Changes in the tropical Pacific sea surface temperature",
                    ...
                    "C. Both A and B", "D. None of the above"],
        "answer": "C",
        "hints": ["el_nino.jpg", "la_nina.jpg", "el_nino_year.jpg"]
    },
    {
    ...
    },
    {
        ...
        "answer": "D",
        "hints": ["oregon.png", "westcoast.jpg"]
    },
    {
    ...
    },
    {
        ...
        "answer": "E",
        "hints": ["tree_rings.png", "ice_core.png", "ice_core2.png"]
    },
    {
